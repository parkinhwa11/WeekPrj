...
rec_place = ['Gyeonggijeon',
             ...
             'Jaman Mural Village']
#추천 장소 이미지 경로 4개
rec_place_img = ['img/jongheok/전북/경기전.jpg',
                 'img/jongheok/전북/전주한옥마을.jpg',
                 'img/jongheok/전북/오목대.jpg',
                 'img/jongheok/전북/자만벽화마을.jpg']
#추천 장소 설명 4개
...
# 관광지 Image
image1 = 'img/jongheok/전북/전주동물원.jpg'
#Wordcloud
image2 = 'img/jongheok/전북/전주동물원 워드클라우드.png'
#파이차트 경로
...
image3 = 'img/jongheok/전북/전주동물원 그래프.png'
...
rec_place = ['Jeonju Hanok Village',
             ...
             'Jaman Mural Village']
#추천 장소 이미지 경로 4개
rec_place_img = ['img/jongheok/전북/전주한옥마을.jpg',
                 'img/jongheok/전북/오목대.jpg',
                 'img/jongheok/전북/풍남문.jpg',
                 'img/jongheok/전북/자만벽화마을.jpg']
#추천 장소 설명 4개
rec_caption = ['It is a cultural village with traditional hanok, calligraphy museum, and traditional liquor museum.',
               ...
               'It is a village with various cartoon-style murals painted on houses and narrow alleys on the hill.']
# 관광지 Image
image1 = 'img/jongheok/전북/경기전.jpg'
#Wordcloud
image2 = 'img/jongheok/전북/경기전 워드클라우드.png'
#파이차트 경로
...
neg = 49
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/전북/경기전 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
rec_caption = ['Built in 1410, this famous temple has a museum featuring historical exhibits and portraits of kings.',
               ...
               'The south gate of the former Jeonju Eupseong in Jeonju-si, Jeonbuk Special Self-Governing Province. It was designated as a treasure on January 21, 1963.']
# 관광지 Image
image1 = 'img/jongheok/전북/전주한옥마을.jpg'
#Wordcloud
image2 = 'img/jongheok/전북/전주한옥마을 워드클라우드.png'
#파이차트 경로
...
neg = 206
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/전북/전주한옥마을 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
rec_place = ['Seonyudo Beach',
             ...
             'Gogunsan Islands']
#추천 장소 이미지 경로 4개
rec_place_img = ['img/jongheok/전북/선유도해수욕장.jpg',
                 'img/jongheok/전북/새만금방조제.jpg',
                 'img/jongheok/전북/장자도.jpg',
                 'img/jongheok/전북/고군산군도.jpg']
#추천 장소 설명 4개
...
# 관광지 Image
image1 = 'img/jongheok/전북/경암동철길마을.jpg'
#Wordcloud
image2 = 'img/jongheok/전북/경암동철길마을 워드클라우드.png'
#파이차트 경로
...
neg = 105
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/전북/경암동철길마을 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
rec_place = ['Daeah Arboretum',
             ...
             'Jeonju Hyanggyo']
#추천 장소 이미지 경로 4개
rec_place_img = ['img/jongheok/전북/대아수목원.jpg',
                 'img/jongheok/전북/전주한옥마을.jpg',
                 'img/jongheok/전북/경기전.jpg',
                 'img/jongheok/전북/전주향교.jpg']
#추천 장소 설명 4개
...
# 관광지 Image
image1 = 'img/jongheok/전북/한국도로공사 전주수목원.jpg'
#Wordcloud
image2 = 'img/jongheok/전북/한국도로공사 전주수목원 워드클라우드.png'
#파이차트 경로
...
neg = 36
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/전북/한국도로공사 전주수목원 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
