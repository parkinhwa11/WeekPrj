...
# 관광지 Image
image1 = 'img/jongheok/경기/에버랜드.jpg'
#Wordcloud
image2 = 'img/jongheok/경기/에버랜드 워드클라우드.png'
#파이차트 경로
...
image3 = 'img/jongheok/경기/에버랜드 그래프.png'
...
rec_place = ['Pocheon Art Valley',
             ...
             'Suwon Hwaseong']
#추천 장소 이미지 경로 4개
rec_place_img = ['img/jongheok/경기/포천아트밸리.jpg',
                 'img/jongheok/경기/벽초지수목원.jpg',
                 'img/jongheok/경기/남한산성.jpg',
                 'img/jongheok/경기/수원화성.jpg']
#추천 장소 설명 4개
...
# 관광지 Image
image1 = 'img/jongheok/경기/화담숲.png'
#Wordcloud
image2 = 'img/jongheok/경기/화담숲 워드클라우드.png'
#파이차트 경로
...
neg = 196
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/경기/화담숲 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
# 관광지 Image
image1 = 'img/jongheok/경기/서울랜드.jpg'
#Wordcloud
image2 = 'img/jongheok/경기/서울랜드 워드클라우드.png'
#파이차트 경로
...
neg = 94
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/경기/서울랜드 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
rec_place = ['Daebudo Island',
             ...
             'First Garden']
#추천 장소 이미지 경로 4개
rec_place_img = ['img/jongheok/경기/대부도.jpg',
                 'img/jongheok/경기/루덴시아.jpg',
                 'img/jongheok/경기/벽초지수목원.jpg',
                 'img/jongheok/경기/퍼스트가든.jpg']
#추천 장소 설명 4개
...
# 관광지 Image
image1 = 'img/jongheok/경기/니지모리스튜디오.jpg'
#Wordcloud
image2 = 'img/jongheok/경기/니지모리스튜디오 워드클라우드.png'
#파이차트 경로
...
neg = 652
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/경기/니지모리스튜디오 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
rec_place_img = ['img/jongheok/경기/용인농촌테마파크.jpg',
                 'img/jongheok/경기/용인자연휴양림.jpg',
                 'img/jongheok/경기/에버랜드.jpg',
                 'img/jongheok/경기/보정동 카페거리.jpg']
#추천 장소 설명 4개
rec_caption = ['Yongin Rural Theme Park is a large-scale comprehensive experience facility suitable for rural and rural characteristics considering the connection with surrounding tourism resources.',
               "Yongin Natural Recreation Forest, created by Yongin-si, Gyeonggi-do, at the foot of Jeonggwangsan Mountain in Mohyeon-eup, is a stay-type rest area with accommodations, trails, and children's playgrounds with beautiful natural scenery.",
...
# 관광지 Image
image1 = 'img/jongheok/경기/한국민속촌.jpg'
#Wordcloud
image2 = 'img/jongheok/경기/한국민속촌 워드클라우드.png'
#파이차트 경로
...
neg = 197
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/경기/한국민속촌 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
