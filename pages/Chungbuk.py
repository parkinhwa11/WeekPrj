...
# 관광지 Image
image1 = 'img/jongheok/충북/청남대.jpg'
#Wordcloud
image2 = 'img/jongheok/충북/청남대 워드클라우드.png'
#파이차트 경로
...
image3 = 'img/jongheok/충북/청남대 그래프.png'
...
# 관광지 Image
image1 = 'img/jongheok/충북/포레스트리솜 해브나인스파.jpg'
#Wordcloud
image2 = 'img/jongheok/충북/포레스트리솜 해브나인스파 워드클라우드.png'
#파이차트 경로
...
neg = 100
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/충북/포레스트리솜 해브나인스파 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
# 관광지 Image
image1 = 'img/jongheok/충북/의림지.jpg'
#Wordcloud
image2 = 'img/jongheok/충북/의림지 워드클라우드.png'
#파이차트 경로
...
neg = 100
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/충북/의림지 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
# 관광지 Image
image1 = 'img/jongheok/충북/충주라바랜드.jpg'
#Wordcloud
image2 = 'img/jongheok/충북/충주라바랜드 워드클라우드.png'
#파이차트 경로
...
neg = 100
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/충북/충주라바랜드 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
...
rec_caption = ['It is a rocky cliff that rises above the water, and is 700m long.',
               ...
               'When you climb the observatory, you can see the clear Daecheong Lake, and when you enter the water promotion hall, there is a video facility that provides a clear view of water-related materials, dam construction, and various financial resources, serving as a water resource learning center.']
# 관광지 Image
image1 = 'img/jongheok/충북/수생식물학습원.jpg'
#Wordcloud
image2 = 'img/jongheok/충북/수생식물학습원 워드클라우드.png'
#파이차트 경로
...
neg = 100
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/jongheok/충북/수생식물학습원 그래프.png'
#tabnum만 바꿔주기 (tab1, tab2, tab3, tab4, tab5)
