...
# -------------------------(dict)-----------------------------
dict1 = {
        '경복궁': ['Gyeongbokgung', 'img/sujeong/경복궁.jpg', 'Gyeongbokgung Palace was built as the official palace of the Joseon dynasty by Yi Seong-gye, who becomes King Taejo and the founder of the new regime. Gyeongbokgung Palace is arguably the most beautiful and is the largest of all five palaces.'],
        ...
        '광화문': ['Gwanghwamun', 'img/sujeong/광화문.jpg', "Built in 1395 under the reign of King Taejo, the first king of the Joseon dynasty, Gwanghwamun Gate is the southern gate of Gyeongbokgung Palace. It is also the main gate of the palace, therefore larger and fancier in comparison to the other gates."],
...
neg = 10
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/sujeong/서울/석촌호수서호그래프.png'
