...
#추천 장소 이미지 경로 4개
rec_place_img = ['img/inhwa/목포유달산승강장.jpg', 'img/inhwa/목포스카이워크.jpg', 'img/inhwa/유달산.jpg', 'img/inhwa/목포갓바위.jpg']
#추천 장소 설명 4개
...
# 관광지 Image
image1 = 'img/inhwa/목포북항승강장.jpg'
#Wordcloud
image2 = 'img/inhwa/목포해상케이블카 북항승강장 워드클라우드.png'
#파이차트 경로
...
image3 = 'img/inhwa/목포해상케이블카 북항승강장그래프.png'
...
#추천 장소 이미지 경로 4개
rec_place_img = ['img/inhwa/순천만습지.jpg', 'img/inhwa/오천그린광장.jpg', 'img/inhwa/순천만자연생태관.jpg', 'img/inhwa/순천낙안읍성.jpg']
#추천 장소 설명 4개
...
# 관광지 Image 1
image1 = 'img/inhwa/순천만국가정원.jpg'
#Wordcloud Image 2
image2 = 'img/inhwa/순천만국가정원 워드클라우드.png'
#파이차트 경로
...
neg_cnt = 202
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/inhwa/순천만국가정원그래프.png'
...
#추천 장소 이미지 경로 4개
rec_place_img = ['img/inhwa/여수포차거리.jpg', 'img/inhwa/고소동벽화마을.jpg', 'img/inhwa/여수해상케이블카.jpg', 'img/inhwa/여수크루즈.jpg']
#추천 장소 설명 4개
...
# 관광지 Image 1
image1 = 'img/inhwa/이순신광장.jpg'
#Wordcloud Image 2
image2 = 'img/inhwa/이순신광장 워드클라우드.png'
#파이차트 경로
...
#추천 장소 이미지 경로 4개
rec_place_img = ['img/inhwa/순천만자연생태관.jpg', 'img/inhwa/순천만국가정원.jpg', 'img/inhwa/와온해변.jpg', 'img/inhwa/순천낙안읍성.jpg']
#추천 장소 설명 4개
rec_caption = ['At the Suncheon Bay Natural Ecology Center, an ecological learning center where you can see and learn information about the various creatures of Suncheon Bay, you can listen to interesting explanations about Suncheon Bay with a guide.',
                ...
                'It is a castle built with earth in the early Joseon Dynasty to prevent damage from frequent Japanese invasions starting from the late Goryeo Dynasty.']
# 관광지 Image 1
image1 = 'img/inhwa/순천만습지.jpg'
#Wordcloud Image 2
image2 = 'img/inhwa/순천만습지 워드클라우드.png'
#파이차트 경로
...
#추천 장소 이미지 경로 4개
rec_place_img = ['img/inhwa/담양국수거리.jpg', 'img/inhwa/메타프로방스.jpg', 'img/inhwa/메타세쿼이아.jpg', 'img/inhwa/소쇄원.jpg']
#추천 장소 설명 4개
...
# 관광지 Image 1
image1 = 'img/inhwa/담양관방제림.jpg'
#Wordcloud Image 2
image2 = 'img/inhwa/담양관방제림 워드클라우드.png'
#파이차트 경로
...
neg_cnt = 23
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/inhwa/담양관방제림그래프.png'
