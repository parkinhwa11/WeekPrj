...
dict1 = {
    ...
    '영종도' : ['Yeongjongdo Island', 'img/sujeong/영종도.jpg', 'Yeongjongdo Island, combined with Yongyudo and Sammokdo Islands through land reclamation work, connects to the mainland via Yeongjongdaegyo Bridge and is located 3 kilometers northwest of Yeonan Pier, Incheon.'],
    ...
    '마시안해변' : ['Masian Beach', 'img/sujeong/마시안해변.jpg',"Located in the vicinity of Incheon International Airport, Masian Beach is unique in that it offers visitors an opportunity to experience both wetland and a sandy beach at the same time. When the tide is low, visitors will be fascinated by the distinctive co-existence of endless black wetland and the ivory sandy beach."],
    ...
    '강화도':['Ganghwado Island','img/sujeong/강화도.jpg', "Ganghwado Island, off the west coast, is the fifth largest island in Korea. The island was connected to the mainland in 1970 with the construction of the Ganghwagyo Bridge."],
...
image3 = 'img/sujeong/인천/월미도그래프.png'
...
neg = 32
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/sujeong/인천/인천대공원그래프.png'
...
neg = 11
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/sujeong/인천/월미테마파크그래프.png'
...
neg = 8
#Bigram NetworkX Graph 이미지 첨부
image3 = 'img/sujeong/인천/송월동동화마을그래프.png'
